...
<head>
    ...
    <link rel="stylesheet" href="../../styles/admin/subjects/subject.css?v=<?= $pubFileVer; ?>" type="text/css">
...
<div id="container">
    ...
    <div id="body">
        <div class="desktop">
            ...
            <div class="subject-edit-buttons">
                <a href="./editsubject.php?s=<?= $subjId; ?>" class="edit-button">Επεξεργασία Μαθήματος<img src="../../resources/edit-icon.png" /></a>
                <a href="./students.php?s=<?= $subjId; ?>" class="edit-button">Επεξεργασία Μαθητών<img src="../../resources/edit-icon.png" /></a>
            </div>

            <div class="main-content">
				<!-- <?= (microtime(true) - $time_start) ?> -->
                <div class="main-left-column">
                    <a href="./newpost.php?s=<?= $subjId; ?>" class="new-post-button">Νέα Ανακοίνωση<img src="../../resources/new.png" /></a>
                    <?php
                                ...
                                function showMonth(month, year){
                                    ...
                                    cal.forEach(e => {
                                        ...
                                        for(let i = 1; i <= dim; i++){
                                            ...
                                            el.innerHTML = i;
                                            el.href = './calendar.php?s=' + s + '&d=' + i + '&m=' + (tmpmonth+1) + '&y=' + tmpyear;
                                            el.classList.add('calendar__number');
                                ...
                                <?php
                                    ...
                                    for($i = 1; $i <= $dim; $i++){
                                        if($i == $day){
                                            ...
                                            echo '<a class="calendar__number today hasevent" href="./calendar.php?s=' . $subjId . '&d=' . $i . '&m=' . (int)$month . '&y=' . $year . '">' . $i . '</a>';
                                            else echo '<a class="calendar__number today" href="./calendar.php?s=' . $subjId . '&d=' . $i . '&m=' . (int)$month . '&y=' . $year . '">' . $i . '</a>';
                                        }
                                        else {
                                            if(in_array($year . '-' . (int)($month) . '-' . $i, $edat))
                                            echo '<a class="calendar__number hasevent" href="./calendar.php?s=' . $subjId . '&d=' . $i . '&m=' . (int)$month . '&y=' . $year . '">' . $i . '</a>';
                                            else echo '<a class="calendar__number" href="./calendar.php?s=' . $subjId . '&d=' . $i . '&m=' . (int)$month . '&y=' . $year . '">' . $i . '</a>';
                                        }
                                    }
                                ?>
                            </div>
        ...
        <div class="mobile">
            ...
            <div id="subject-posts">
                <a href="./newpost.php?s=<?= $subjId; ?>" class="new-post-button">Νέα Ανακοίνωση<img src="../../resources/new.png" /></a><br><br>
                <?php
