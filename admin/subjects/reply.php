...
<head>
    ...
    <link rel="stylesheet" href="../../styles/admin/subjects/reply.css?v=<?= $pubFileVer; ?>" type="text/css">
    ...
    <div id="body">
        <div class="desktop">
            ...
            <div class="test-display">
                ...
                <form action="../../includes/admin/subjects/ratetest.inc.php" method="POST" onsubmit="document.getElementById('action-hider').style.display = 'block';">
                <?php
        ...
        <?php if($replyData == null): ?>
            ...
            <div class="test-display">
                <div class="reply-info">
                    ...
                    foreach($replyData as $d){
                        if($d[1] == 0){
                            echo '<p class="info-title" style="color: orange">Η βαθμολογία δεν έχει ολοκληρωθεί!</p>';
                            break;
                        }
                    }
                    
                    ?>
                    <p class="info-text" style="color: red;">*Ο μαθητής/τρια θα μπορεί να δει τα αποτελέσματά του μετά τη λήξη του test</p><br>
                    <a href="./reply.php?id=<?= $testId; ?>" class="button">Πίσω</a><br>
                    <div class="info-cont">
                        <p class="info-title">Ώρα Εκκίνησης:</p>
                        <p class="info-text"><?php
