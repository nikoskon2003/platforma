...
<head>
    ...
    <title><?= $siteName; ?> | Νέα Ανακοίνωση - <?= $subjName; ?></title>
...
<div id="container">
	...
	<div id="body">
        <div class="home">
            <div class="desktop">
            <div class="title">Νέα Ανακοίνωση - <?= $subjName; ?></div>
			<?php
				if($subjClass != null) echo '<p class="subtitle">' . $subjClassName . '</p>';
			?>
            <div id="box-container">
                <form id="desktop-form" action="../../includes/admin/subjects/newpost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
                    ...
                    <div class="options-parent">
                        ...
                        <div class="bottom-buttons">
                            <input type="hidden" name="subject-id" value="<?= $subjId;?>"/>
                            <button type="submit" name="submit" value="submit" class="submit-button">Υποβολή</button>
                            <a href="./subject.php?s=<?= $subjId; ?>" class="cancel-button">Άκυρο</a>
                        </div>
                    </div>
                </form>
            </div>
			...
			?>
            <div id="box-container">
                <form id="mobile-form" action="../../includes/admin/subjects/newpost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                    <div class="template-post">
