    ...
    <div id="body">
        <div class="desktop">
            ...
            <div class="assignments-cont">
                <div class="left-side">
                    <div class="new-assignment"><a href="./assignments.php?s=<?= $subjId; ?>&a=new">Νέα Εργασία<img src="../../resources/new.png"/></a></div>
                    <?php 
                    ...
                    <?php else: ?>
                        <label class="assignment-edit-area">
                            ...
                            <div class="edit-area-cont">
                                ...
                                <form action="../../includes/admin/subjects/deleteassignment.inc.php" method="POST" onsubmit="if(!confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε αυτήν την εργασία; Θα διαγραφούν όλα τα δεδομένα σχετικά με αυτήν!'))return false;document.getElementById('action-hider').style.display = 'block';">
                                    <input type="hidden" name="id" value="<?= $assignmentId; ?>"/>
