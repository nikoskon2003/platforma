...
$postId = (int)$_GET['id'];
$res = mysqli_query($conn, "SELECT * FROM posts WHERE post_id=$postId AND post_usage='subject'");
if($res->num_rows < 1){
    header("Location: ./");
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="../../styles/admin/subjects/newpost.css?v=<?= $pubFileVer; ?>" type="text/css">
	...
	<div id="body">
        <div class="home">
            ...
            <div id="box-container">
                <form id="desktop-form" action="../../includes/admin/subjects/editpost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
                ...
                <br>
                <form action="../../includes/admin/subjects/deletepost.inc.php" method="POST" onsubmit="if(!confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε την ανακοίνωση;'))return false;document.getElementById('action-hider').style.display = 'block';" style="text-align: center;padding-bottom:5px;margin-top: 10px;">
                    <input type="hidden" name="id" value="<?= $postId; ?>" />
			...
			?>
            <div id="box-container">
                <form id="mobile-form" action="../../includes/admin/subjects/editpost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                <div class="template-post">
                ...
                <br>
                <form action="../../includes/admin/subjects/deletepost.inc.php" method="POST" onsubmit="return confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε την ανακοίνωση;');" style="text-align: center;padding-bottom:5px;margin-top: 10px;">
                    <input type="hidden" name="id" value="<?= $postId; ?>" />
                    <button type="submit" name="delete" value="delete" class="cancel-button">Διαγραφή</button>
                </form>
            </div>
