...
<head>
    ...
    <link rel="stylesheet" href="../../styles/admin/program/editors.css?v=<?= $pubFileVer; ?>" type="text/css">
    ...
    <div id="body">
        <div class="desktop">
            ...
            <div class="authors-cont">
                ...
                <form action="../../includes/admin/program/editors.inc.php" method="POST" onsubmit="document.getElementById('action-hider').style.display = 'block';">
                ...
                <?php
                    $res = mysqli_query($conn, "SELECT * FROM user_links WHERE link_usage='program-editor'");
                    if($res->num_rows < 1) echo '<p class="field-label">Κανένας συντάκτης</p>';
                        ...
                        if($result->num_rows < 1) mysqli_query($conn, "DELETE FROM user_links WHERE link_usage='program-editor' AND link_user='$username'");
                        else
                        {
                            ...
                            echo "<form class='user' action='../../includes/admin/program/editors.inc.php' method='POST' onsubmit=\"if(!confirm('Θέλετε σίγουρα να διαγράψετε αυτόν το συντάκτη;'))return false;document.getElementById('action-hider').style.display = 'block';\">
