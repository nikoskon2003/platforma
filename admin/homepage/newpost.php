...
<head>
    ...
    <title><?= $siteName; ?> | Νέα Ανακοίνωση</title>
	...
	<div id="body">
        <div class="home">
            ...
            <div id="box-container">
                <form id="desktop-form" action="../../includes/admin/homepage/newpost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
            ...
            <div class="title">Νέα Ανακοίνωση</div>
            <div id="box-container">
                <form id="mobile-form" action="../../includes/admin/homepage/newpost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                    <div class="template-post">
