...
if($_SESSION['type'] !== 'ADMIN' && $postData['post_author'] !== $_SESSION['user_username']){
    header("Location: ./");
    exit();
}
...
<head>
    ...
    <title><?= $siteName; ?> | Επεξεργασία Ανακοίνωσης</title>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <link rel="stylesheet" href="../../styles/admin/homepage/newpost.css?v=<?= $pubFileVer; ?>" type="text/css">
	...
	<div id="body">
        <div class="home">
            ...
            <div id="box-container">
                <form id="desktop-form" action="../../includes/admin/homepage/editpost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
                    ...
                    <div class="options-parent">
                        <div class="left-options">
                            ...
                            <div class="radio-holder">
                                ...
                                <label class="radio-cont-vis">
                                    <input type="radio" name="visibility" value="users" <?= $users; ?>>
                                    <div class="radio-child">Χρήστες</div>
                                </label>
                                <label class="radio-cont-vis">
                        ...
                        <div class="bottom-buttons">
                            ...
                            <a href="./" class="cancel-button">Άκυρο</a>
                        </div>
                    </div>
                </form>
                <br>
                <form action="../../includes/admin/homepage/deletepost.inc.php" method="POST" onsubmit="if(!confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε την ανακοίνωση;'))return false;document.getElementById('action-hider').style.display = 'block';" style="text-align: center;padding-bottom:5px;margin-top: 10px;">
                    <input type="hidden" name="id" value="<?= $postId; ?>" />
            ...
            <div class="mobile">
            <div class="title">Νέα Ανακοίνωση</div>
            <div id="box-container">
                <form id="mobile-form" action="../../includes/admin/homepage/editpost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                <div class="template-post">
