	...
	<div id="body">
        <div class="home">
            ...
            <div id="box-container">
                <form id="desktop-form" action="../../includes/admin/classes/editpost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
                ...
                <br>
                <form action="../../includes/admin/classes/deletepost.inc.php" method="POST" onsubmit="if(!confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε την ανακοίνωση;')) return false; else document.getElementById('action-hider').style.display = 'block';" style="text-align: center;padding-bottom:5px;margin-top: 10px;">
                    <input type="hidden" name="id" value="<?= $postId; ?>" />
            ...
            <div id="box-container">
                <form id="mobile-form" action="../../includes/admin/classes/editpost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                <div class="template-post">
