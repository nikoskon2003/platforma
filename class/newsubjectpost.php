	...
	<div id="body">
        <div class="home">
            ...
            <div id="box-container">
                <form id="desktop-form" action="../includes/class/newsubjectpost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
			...
			?>
            <div id="box-container">
                <form id="mobile-form" action="../includes/class/newsubjectpost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                    <div class="template-post">
