...
if($_SESSION['type'] === 'ADMIN'){
    header("Location: ../admin/classes/newpost.php?c=" . $_GET['c']);
    exit();
}
	...
	<div id="body">
        <div class="home">
            ...
            <div id="box-container">
                <form id="desktop-form" action="../includes/class/newclasspost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
            ...
            <div class="title">Νέα Ανακοίνωση - <?= $className; ?></div>
            <div id="box-container">
                <form id="mobile-form" action="../includes/class/newclasspost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                    <div class="template-post">
