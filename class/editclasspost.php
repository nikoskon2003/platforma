...
$classId = (int)$postData['post_used_id'];
...
<head>
    ...
    <title><?= $siteName; ?> | Επεξεργασία Ανακοίνωσης - <?= $className; ?></title>
	...
	<div id="body">
        <div class="home">
            ...
            <div id="box-container">
                <form id="desktop-form" action="../includes/class/editclasspost.inc.php" method="POST" onsubmit="return validateForm('desktop');">
                ...
                <br>
                <form action="../includes/class/deleteclasspost.inc.php" method="POST" onsubmit="if(!confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε την ανακοίνωση;'))return false;document.getElementById('action-hider').style.display = 'block';" style="text-align: center;padding-bottom:5px;margin-top: 10px;">
                    <input type="hidden" name="id" value="<?= $postId; ?>" />
            ...
            <div id="box-container">
                <form id="mobile-form" action="../includes/class/editclasspost.inc.php" method="POST" onsubmit="return validateForm('mobile');">
                <div class="template-post">
