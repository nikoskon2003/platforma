...
if(isset($_POST['submit'])){
    ...
    if($password != '' && $password != ' '){
        ...
        mysqli_query($conn, "UPDATE users SET user_password='$encPass', user_secret='$sec', user_name='$name' WHERE user_username='$username'");
    }
	else 
        mysqli_query($conn, "UPDATE users SET user_name='$name' WHERE user_username='$username'");
